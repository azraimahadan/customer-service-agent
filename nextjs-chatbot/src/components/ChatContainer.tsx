...
export default function ChatContainer() {
  ...
  return (
    <div className="flex flex-col h-screen max-w-4xl mx-auto bg-surface shadow-ios-lg rounded-ios-lg overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r from-primary to-secondary text-white p-6">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center shadow-ios">
            <Tv size={24} />
          </div>
          <div>
            <h1 className="text-xl font-semibold">SUARA</h1>
            <p className="text-sm opacity-90">AI-Powered Customer Service</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-6 bg-background">
        ...
        {isLoading && (
          <div className="flex gap-3 mb-6">
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-surface border border-gray-200 flex items-center justify-center shadow-ios">
            ...
            <div className="chat-bubble chat-bubble-bot">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-text-secondary">Analyzing your issue...</span>
              </div>
            </div>
          </div>
        )}
